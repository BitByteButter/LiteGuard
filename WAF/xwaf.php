...
class xWAF {
	...
	function vulnDetectedHTML($Method, $BadWord, $DisplayName, $TypeVuln) {
		...
		$logData = '<tr>
                ...
                <tr>
                    <td>URL:</td>
                    <td><span>' . htmlspecialchars($_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'], ENT_QUOTES, 'UTF-8') . '</span></td>
                </tr>
                <tr>
                    <td>Your Browser: </td>
                ...
                <tr>
                    <td>Block ID:</td>
                    <td><span>' . $this->shorten_string(md5($TypeVuln . $Method . $DisplayName . $_SERVER[$this->IPHeader] . date('DmY')), 7) . '</span></td>
                </tr>
                <tr>
                    <td>Block reason:</td>
    ...
    $logEntry = '<table class="property-table overflow-break-all line-height-16">' . $logData . '</table>';

    // Write to logs.html file
    $file = 'logs.html';
